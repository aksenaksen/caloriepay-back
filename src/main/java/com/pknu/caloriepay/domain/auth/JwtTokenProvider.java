package com.pknu.caloriepay.domain.auth;
...
public class JwtTokenProvider {
    ...
    public CurrentMemberInfo extractUserInfo(String token) {
        Long memberId = extractClaim(token, claims -> claims.get("memberId", Long.class));
        System.out.println(memberId.toString());
        return new CurrentMemberInfo(memberId);
    }
    ...
    public String createToken(Map<String, Object> claims, String email, Long validTime) {
        Date now = new Date();
