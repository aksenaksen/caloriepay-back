...
public class TierApi {
    ...
    @GetMapping("/month")
    public ResponseEntity<BaseRes<ResponseTier>> getMothTier(@AuthenticationPrincipal CurrentMemberInfo currentMemberInfo, @RequestParam("year") Long year, @RequestParam Long month){
